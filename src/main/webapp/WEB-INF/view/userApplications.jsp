        ...
        <div class="pages">
            <c:choose>
                <c:when test="${(page - 1) == 0}">
                    ...
                    <a href="${pageContext.request.contextPath}/controller?command=admin_applications&page=1"
                       type="submit"
            ...
            <c:choose>
                ...
                <c:when test="${page == lastPage}">
                    <div class="pagination-children">...</div>
                    <a href="${pageContext.request.contextPath}/controller?command=admin_applications&page=${lastPage}"
                       type="submit"
